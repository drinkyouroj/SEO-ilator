...
- **Embedding providers**: OpenAI (text-embedding-3-small) and Cohere (embed-english-v3.0) with cache, batch processing, and atomic provider switching [AAP-B6]
...
- **Test suite**: 276 tests across 46 files — unit tests, API route tests, integration tests, component tests, accessibility tests
